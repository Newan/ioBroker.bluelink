...
async function setLocation(adaptr, vin, latitude, longitude, speed) {
    ...
    if (isNaN(latitude) || isNaN(longitude)) {
        adaptr.log.warn(`Invalid location coordinates for ${vin}: lat=${latitude}, lon=${longitude}`);
        return;
    }

    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation`, {
        type: 'channel',
        common: {
            name: 'car location',
            write: false,
    ...
    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation.lat`, {
        type: 'state',
        common: {
    ...
    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation.lon`, {
        type: 'state',
        common: {
    ...
    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation.speed`, {
        type: 'state',
        common: {
            name: 'Vehicle speed',
            type: 'number',
    ...
    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation.position_url`, {
        type: 'state',
        common: {
            name: 'Position URL',
            type: 'string',
    ...
    await adaptr.setObjectNotExistsAsync(`${vin}.vehicleLocation.position_text`, {
        type: 'state',
        common: {
            name: 'Position Text',
            type: 'string',
