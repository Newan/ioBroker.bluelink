...
/**
 * Utility class for creating ioBroker objects (channels and states) for a vehicle.
 */
class Create_tools {
    /**
     * Creates a new Create_tools instance.
     *
    ...
    /**
     * Creates all control-related ioBroker objects for the given vehicle.
     *
    ...
    async setControlObjects(vin) {
        ...
        await this.adapter.setObjectNotExistsAsync(`${vin  }.control`, {
            type: 'channel',
            common: {
                name: 'control',
                write: false,
        ...
        if (this.adapter.config.motor == 'EV') {
            ...
            await this.adapter.setObjectNotExistsAsync(`${vin  }.control.clima`, {
                type: 'channel',
                common: {
                    name: 'control clima',
                    write: false,
            ...
            await this.adapter.setObjectNotExistsAsync(`${vin  }.control.clima.set`, {
                type: 'channel',
                common: {
                    name: 'set clima',
                    write: false,
        ...
        await this.adapter.setObjectNotExistsAsync(`${vin  }.control.force_location`, {
            type: 'state',
            common: {
                name: 'Force refresh vehicle location from car',
                type: 'boolean',
                role: 'button',
                read: true,
                write: true,
        ...
        this.adapter.subscribeStates(`${vin  }.control.force_location`);
    ...
    /**
     * Creates all status-related ioBroker objects (location, odometer, etc.) for the given vehicle.
     *
     * @param {string} vin The vehicle identification number (VIN)
     * @returns {Promise<void>}
     */
    async setStatusObjects(vin) {
        ...
        await this.adapter.setObjectNotExistsAsync(`${vin  }.vehicleLocation`, {
            type: 'channel',
            common: {
                name: 'car location',
                write: false,
        ...
        //Bereich Odometer
        await this.adapter.setObjectNotExistsAsync(`${vin  }.odometer`, {
            type: 'channel',
            common: {
                name: 'odometer',
                write: false,
    ...
    /**
     * Creates all vehicle-status ioBroker objects (doors, battery, climate, etc.) for the given vehicle.
     *
     * @param {string} vin The vehicle identification number (VIN)
     * @returns {Promise<void>}
     */
    async setVehicleStatusObjects(vin) {
        await this.adapter.setObjectNotExistsAsync(`${vin  }.vehicleStatus`, {
            type: 'channel',
            common: {
                name: 'vehicleStatus',
                write: false,
        ...
        //Doors open
        await this.adapter.setObjectNotExistsAsync(`${vin  }.vehicleStatus.doorOpen`, {
            type: 'channel',
            common: {
                name: 'door status',
                write: false,
        ...
        await this.adapter.setObjectNotExistsAsync(`${vin  }.vehicleStatus.battery`, {
            type: 'channel',
            common: {
                name: 'battery info',
                write: false,
